...
_.extend(Backbone.History.prototype, {
  getFragment : function(fragment, forcePushState, excludeQueryString) {
    ...
    if (excludeQueryString) {
      ...
      /**
       * VISTAPRINT
       * Backbone Queryparams does not seem to properly consider hashes
       * versus pushState. The location.search object is just a ref. to
       * document.location - so location.search will not contain the
       * query params within the hash
       */
  ...
  getQueryParameters : function(fragment, forcePushState) {
    ...
    if (match) {
      ...
      iterateQueryString(queryString, function(name, value) {
        /**
         * VISTAPRINT
         * We need to decode the params. Apparently this was not being done
         */
